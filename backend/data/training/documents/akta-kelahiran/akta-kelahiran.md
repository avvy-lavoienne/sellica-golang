...
- Peraturan Menteri Dalam Negeri Nomor 73 Tahun 2022 tentang Pencatatan Nama pada Dokumen Kependudukan (aturan penulisan nama: minimal 2 kata, maksimal 60 huruf, tanpa singkatan kecuali tidak diartikan lain, tanpa angka atau tanda baca).
...
- Keputusan Menteri Dalam Negeri Nomor 800.1.4.4-880 Dukcapil Tahun 2025 tentang Penilaian Kinerja Layanan Administrasi Kependudukan Daerah.
...
3. Konsistensi data antar dokumen (termasuk penulisan nama sesuai Permendagri 73/2022 dan tempat lahir sesuai aturan 2025).
...
- Portal Layanan: pastioke.garutkab.go.id (untuk pengajuan online).
...
1. Nama anak harus sesuai aturan (minimal 2 kata, tanpa singkatan/angka).
2. Data orang tua harus akurat dan konsisten.
3. Alamat harus sesuai dengan KK.
4. Gunakan Publish Baby untuk kemudahan jika lahir di fasilitas mitra.

Keywords: tips pemohon akta kelahiran, persiapan dokumen.

## FAQ

- **Apa saja persyaratan utama untuk akta kelahiran normal?** Surat keterangan lahir, KTP dan KK orang tua, serta buku nikah.
- **Apakah biaya pengurusan akta kelahiran gratis?** Ya, gratis jika dilaporkan dalam 60 hari.
- **Bagaimana cara menggunakan layanan Publish Baby?** Melalui fasilitas kesehatan mitra, input data dan upload dokumen via aplikasi.
- **Apa aturan penulisan nama di akta?** Minimal 2 kata, maksimal 60 huruf, tanpa singkatan, angka, atau tanda baca (Permendagri 73/2022).
- **Berapa lama proses penggantian akta hilang?** 1-3 hari kerja dengan surat kehilangan.
...
- Standar Operasional Prosedur (SOP) Disdukcapil Kabupaten Garut (disdukcapil.garutkab.go.id).
- Peraturan Daerah Kabupaten Garut terkait Administrasi Kependudukan.
- Sumber Resmi: peraturan.bpk.go.id untuk unduh Permendagri.
- Artikel Dukcapil: "Ini Aturan Penulisan Tempat Lahir dan Kematian Pada Akta" (dukcapil.kemendagri.go.id, 11 Agustus 2025).
- Artikel Dukcapil: "Cegah Ortu Kasih Nama 1 Huruf, Dukcapil Tegaskan Nama Minimal 2 Kata" (dukcapil.kemendagri.go.id, 22 Juli 2025).
