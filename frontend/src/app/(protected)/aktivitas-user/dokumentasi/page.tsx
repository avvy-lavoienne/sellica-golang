            ...
            >
                ...
                >
                    ...
                    <div className="relative z-10 p-8 md:p-10">
                        <div className="flex flex-col gap-8 laptop:flex-row laptop:items-start laptop:justify-between">
                            <div className="space-y-6 flex-1">
                                <DokumentasiHeader />

                                {/* Enhanced Statistics & Actions Group */}
                      ...
                      Updated {pageStats.lastUpdated.toLocaleTimeString()}
                                    ...
                                    <div className="flex items-center gap-2 border-l pl-4 border-border/50">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button
                                                    variant="ghost" // Menggunakan variant ghost agar lebih menyatu
                                                    size="icon"
                                                    onClick={() =>
                                        ...
                                        {error && (
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Button
                                                        variant="ghost" // Menggunakan variant ghost
                                                        size="icon"
                            ...
                            {/* --- BAGIAN INI SEKARANG KOSONG / DIHAPUS --- */}
                        </div>
                    </div>
                </motion.div>
