...
const LoadingState: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-16 px-6 flex items-center justify-center">
      <Card className="max-w-md w-full p-8 shadow-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
            Mohon tunggu sebentar, kami sedang memuat data pengajuan bulanan...
          </p>
        </div>
