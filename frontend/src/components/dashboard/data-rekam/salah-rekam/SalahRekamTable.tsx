...
const SalahRekamTable: React.FC<SalahRekamTableProps> = ({
  ...
  const handleToggleChange = async (id: string, currentStatus: boolean) => {
    ...
    try {
      ...
      const response = await fetch(
        "/api/data-rekam/salah-rekam-toggle-status",
        {
          method: "PATCH",
          headers: {
  ...
  const handleSaveDate = async (id: string) => {
    ...
    try {
      ...
      const response = await fetch(
        "/api/data-rekam/salah-rekam-update-date",
        {
          method: "PATCH",
          headers: {
            "Authorization": `Bearer ${token}`,
  ...
  return (
    <div className={`space-y-6 ${className || ""}`} role="region" aria-label={ariaLabel || "Tabel data salah rekam"}>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  disabled={loading}
                  className="block w-full px-3 py-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-900 dark:text-white">
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" className="px-6 py-3">NIK / Nama Salah Rekam</th>
                <th scope="col" className="px-6 py-3">NIK / Nama Pemilik Biometric</th>
                <th scope="col" className="px-6 py-3">NIK / Nama Pemilik Foto</th>
                    ...
                    <React.Fragment key={item.id}>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                          <div className="space-y-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-medium">{item.nama_salah_rekam || "-"}</span>
                            </div>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                          <div className="space-y-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-medium">{item.nama_pemilik_biometric || "-"}</span>
                            </div>
                            <div className="pl-6 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                          <div className="space-y-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-medium">{item.nama_pemilik_foto || "-"}</span>
                            </div>
                            <div className="pl-6 text-xs text-gray-500 dark:text-gray-400">
                      ...
                      {isExpanded && (
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td colSpan={7} className="px-6 py-6 bg-gray-50 dark:bg-gray-700/50">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                              {/* Data Salah Rekam */}
                              <div className="space-y-3">
                                <div className="flex items-center space-x-2">
                                  <UserMinusIcon className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                                ...
                                <div className="space-y-2 pl-6">
                                  <div className="flex justify-between">
                                    ...
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nik_salah_rekam || "-"}</span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Nama:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nama_salah_rekam || "-"}</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-3">
                                <div className="flex items-center space-x-2">
                                  <FingerPrintIcon className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                                  <h4 className="text-sm font-semibold text-gray-900 dark:text-white">
                                    Data Pemilik Biometric
                                  </h4>
                                </div>
                                <div className="space-y-2 pl-6">
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">NIK:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nik_pemilik_biometric || "-"}</span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Nama:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nama_pemilik_biometric || "-"}</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="space-y-2 pl-6">
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">NIK:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nik_pemilik_foto || "-"}</span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Nama:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nama_pemilik_foto || "-"}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="space-y-2 pl-6">
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">NIK Petugas Rekam:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nik_petugas_rekam || "-"}</span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Nama Petugas Rekam:</span>
                                    <span className="text-xs text-gray-900 dark:text-white">{item.nama_petugas_rekam || "-"}</span>
                                  </div>
                                  <div className="flex justify-between">
