...
const DuplicateOperatorHeader: React.FC = () => {
  return (
    <div className="mb-8">
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Duplicate Operator", current: true }
        ]}
        className="mb-4"
      />
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="p-4 bg-primary-100 dark:bg-primary-900/30 rounded-lg shadow-lg">
          {/* Flowbite Heroicon integration for user/operator context */}
...
export default DuplicateOperatorHeader;
